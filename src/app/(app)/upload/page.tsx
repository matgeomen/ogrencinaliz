...
import { UploadCloud, File as FileIcon, X, Loader2, Download, AlertCircle, FileSpreadsheet, FileText, CheckCircle } from 'lucide-react';
        ...
        <CardContent className="space-y-4">
            <Alert className="bg-green-50 border-green-200 text-green-900 dark:bg-green-900/20 dark:border-green-700 dark:text-green-200">
                ...
                <AlertDescription className="text-green-800/90 dark:text-green-300/90 text-sm space-y-1 mt-2">
                    <p className="flex items-center"><CheckCircle className="h-4 w-4 mr-2 text-green-600" /> Şablonu indirip kullanın.</p>
                    <p className="flex items-center"><CheckCircle className="h-4 w-4 mr-2 text-green-600" /> Sütun başlıkları değiştirilmemeli.</p>
                    <p className="flex items-center"><CheckCircle className="h-4 w-4 mr-2 text-green-600" /> Her satır bir öğrencinin tek bir deneme sonucunu temsil etmeli.</p>
                </AlertDescription>
            </Alert>
             <Alert className="bg-red-50 border-red-200 text-red-900 dark:bg-red-900/20 dark:border-red-700 dark:text-red-200">
                ...
                <AlertDescription className="text-red-800/90 dark:text-red-300/90 text-sm space-y-1 mt-2">
                    <p className="flex items-center"><CheckCircle className="h-4 w-4 mr-2 text-red-600" /> AI ile otomatik parse edilir (E-Okul sayfası için optimize edilmiştir).</p>
                    <p className="flex items-center"><CheckCircle className="h-4 w-4 mr-2 text-red-600" /> Tablo formatı önerilir.</p>
                </AlertDescription>
            </Alert>
        </CardContent>
      </Card>
